...
Датасет представляет собой отзывы на ИТ-товары, девайсы и приложения. Поскольку в нашем случае задача состоит в определении отзывов на ИТ-дисциплины, данный датаест подходит для задачи текстовой классификации.
